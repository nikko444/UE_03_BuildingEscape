...
private:
	...
	enum ReachLineParameter{START, END}; //Used by GetReachline method
	
	// with ReachLineParameter START Returns start of the reach line, with END returns the end of the reach line
